...
// All-Button's Event (Show Menu Event- Butona tıklandığında menüyü getirme eventi)
buttons.addEventListener('click', showMenu);

// Buton ile menü çağırma Fonksiyonu - showMenu()
function showMenu(e) {
  if(e.target.className.includes("all")) {
    foodCards.innerHTML = ""; // DOM un içindeki itemları boşaltma
    menu.map((item) => foodCards.innerHTML += `
    <div class="card shadow p-3 mb-5 bg-white rounded" style="width: 18rem;">
    <img src="${item.img}">
    <div class="card-body">
